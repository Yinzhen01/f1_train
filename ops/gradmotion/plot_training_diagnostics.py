...
def write_summary(data: dict[str, object], output: Path) -> None:
    ...
    lines = [
        ...
        "",
        "There is currently no per-joint Cartesian/keypoint position failure threshold in the training code.",
        "Spatial body/keypoint position error is diagnostic-only when body_pos/body_names exist in the motion NPZ.",
        "",
